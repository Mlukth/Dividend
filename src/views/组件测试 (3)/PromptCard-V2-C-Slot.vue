  ...
  <div class="slot-container">
    ...
    <div class="card-grid">
      <div 
        ...
        :key="card.id"
        :class="['card-wrapper', card.rarity]"
      >
        <div :class="['card-slot', card.rarity]" @click="selectedCard = card">
...
/* 不同稀有度的槽位底色 */
.card-wrapper.bronze .card-slot {
  --slot-bg: linear-gradient(145deg, rgba(80, 50, 25, 0.4) 0%, rgba(50, 30, 15, 0.3) 100%);
  --slot-border: rgba(205, 127, 50, 0.25);
  --hover-bg: linear-gradient(145deg, rgba(205, 127, 50, 0.35) 0%, rgba(150, 90, 35, 0.25) 100%);
  --hover-border: rgba(205, 127, 50, 0.7);
}

.card-wrapper.silver .card-slot {
  --slot-bg: linear-gradient(145deg, rgba(60, 70, 80, 0.4) 0%, rgba(40, 50, 60, 0.3) 100%);
  --slot-border: rgba(168, 212, 255, 0.2);
  --hover-bg: linear-gradient(145deg, rgba(168, 212, 255, 0.3) 0%, rgba(120, 160, 200, 0.2) 100%);
  --hover-border: rgba(168, 212, 255, 0.6);
}

.card-wrapper.gold .card-slot {
  --slot-bg: linear-gradient(145deg, rgba(80, 70, 30, 0.5) 0%, rgba(50, 45, 20, 0.4) 100%);
  --slot-border: rgba(255, 215, 0, 0.25);
  --hover-bg: linear-gradient(145deg, rgba(255, 215, 0, 0.35) 0%, rgba(200, 160, 50, 0.25) 100%);
  --hover-border: rgba(255, 215, 0, 0.7);
}
...
.card-wrapper.bronze:hover .slot-glow {
  opacity: 1;
  background: radial-gradient(ellipse at center bottom, rgba(205, 127, 50, 0.2) 0%, transparent 60%);
}

.card-wrapper.silver:hover .slot-glow {
  opacity: 1;
  background: radial-gradient(ellipse at center bottom, rgba(168, 212, 255, 0.2) 0%, transparent 60%);
}

.card-wrapper.gold:hover .slot-glow {
  opacity: 1;
  background: radial-gradient(ellipse at center bottom, rgba(255, 215, 0, 0.25) 0%, transparent 60%);
}
