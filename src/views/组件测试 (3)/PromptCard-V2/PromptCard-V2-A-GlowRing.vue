...
.prompt-card.bronze {
  --card-color: #cd7f32;
  background: linear-gradient(145deg, #1a1512 0%, #12100e 100%);
}
.prompt-card.bronze::after {
  background: radial-gradient(ellipse at center, rgba(205, 127, 50, 0.3) 0%, transparent 70%);
  box-shadow: 0 0 20px rgba(205, 127, 50, 0.2);
}
.prompt-card.bronze:hover {
  transform: translateY(-8px) rotateX(2deg) rotateY(-2deg);
}
.prompt-card.bronze:hover::before {
  background: linear-gradient(135deg, #a8a8a8 0%, #888 100%);
  opacity: 1;
}
.prompt-card.bronze:hover::after {
  opacity: 1;
}
...
.prompt-card.silver:hover::before {
  background: linear-gradient(135deg, #ffd700 0%, #daa520 100%);
  opacity: 1;
}
.prompt-card.silver:hover::after {
  opacity: 1;
}
...
.prompt-card.gold {
  --card-color: #ffd700;
  background: linear-gradient(145deg, #1f1a12 0%, #151210 100%);
}
.prompt-card.gold::after {
...
.rarity-badge.bronze { background: rgba(205, 127, 50, 0.2); color: #cd7f32; }
.rarity-badge.silver { background: rgba(192, 192, 192, 0.2); color: #c0c0c0; }
.rarity-badge.gold { background: rgba(255, 215, 0, 0.2); color: #ffd700; }
...
.modal-rarity.bronze { background: rgba(205, 127, 50, 0.2); color: #cd7f32; }
.modal-rarity.silver { background: rgba(192, 192, 192, 0.2); color: #c0c0c0; }
.modal-rarity.gold { background: rgba(255, 215, 0, 0.2); color: #ffd700; }
