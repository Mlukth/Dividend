...
<!-- 翻译输入区 -->
    ...
    <!-- 词根词缀分析 -->
    <el-dialog v-model="showWordAnalysis" title="词根词缀分析" width="580px" destroy-on-close class="wa-dialog" @closed="wordAnalysis=null;showWordAnswer=false;userMeaningGuess=''">
      <div v-if="wordAnalyzing" class="wa-loading">
